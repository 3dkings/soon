...
//player stuff
let enterButton=document.getElementById("msg")
let volumeButton=document.getElementById("3dlogo")
...
function awaken(){
goblinSong.src="./assets/music.mp3"
goblinSong.volume=0.5
goblinSong.loop=true
volumeButton.onclick=function(){togglePlay()}
}


window.addEventListener("load",async()=>{await delay(1)
awaken()
})
